...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequiredRangeParameters', function() {
      beforeEach(function() {
        instance = new OsuCollector.RequiredRangeParameters();
      });

      it('should create an instance of RequiredRangeParameters', function() {
        // TODO: update the code to test RequiredRangeParameters
        expect(instance).to.be.a(OsuCollector.RequiredRangeParameters);
      });
