...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RangeParametersWithDate', function() {
      beforeEach(function() {
        instance = new OsuCollector.RangeParametersWithDate();
      });

      it('should create an instance of RangeParametersWithDate', function() {
        // TODO: update the code to test RangeParametersWithDate
        expect(instance).to.be.a(OsuCollector.RangeParametersWithDate);
      });
