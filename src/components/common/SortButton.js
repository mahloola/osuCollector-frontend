...
const StyledButton = styled.button`
    ...
    background-color: ${props =>
        props.theme.darkMode ?
            (props.active ? props.theme.primary50 : props.theme.primary25)
            :
            (props.active ? '#e6e6e6' : '#f1f1f1')
    };
    
    &:hover, &:active {
        background-color: ${props =>
            props.theme.darkMode ?
                (props.active ? props.theme.primary60 : props.theme.primary35)
                :
                (props.active ? '#eee' : '#ddd')
    };
    }
`
