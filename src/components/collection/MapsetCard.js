...
import { Badge, Button, Card, CardFooter, Col, Container, Image, ListGroup, ListGroupItem, Row } from '../bootstrap-osu-collector'
        ...
        <div className={className}>
                        ...
                        <div className='d-flex justify-content-between'>
                            ...
                            <div className='align-self-center'>
                                <button className='media-play-button p-0' onClick={onPlayClick}>
                                    {playing ? <StopFill className='svg-shadow' size={40} /> : <PlayFill className='svg-shadow' size={40} />}
                                </button>
                            </div>
                        </div>
                    </Card.ImgOverlay>
                        ...
                        {beatmaps.map(beatmap =>
                            <ListGroupItem $lightbg key={beatmap.id} className='px-2'>
                                <div className='d-flex align-items-center p-0'>
                                    <Badge className='mr-1' variant='secondary' style={{ minWidth: '50px', height: '24px', paddingTop: '6px' }}>
                                    ...
                                    {beatmap.mode !== 'osu' &&
                                        <Image
                                            ...
                                            size={20}
                                            style={{ imageRendering: 'auto', width: '18px', height: 'auto' }}
                                            className='mr-2'
                                        />
                                    }
            ...
            <Full>
                <div className='d-flex '>
                    ...
                    {/* diffs */}
                    <Container className='p-0'> <Row> <Col>
                        <Card>
                            <ListGroup variant='flush'>
                                {beatmaps.map(beatmap =>
                                    <ListGroupItem $lightbg key={beatmap.id} className='px-2'>
