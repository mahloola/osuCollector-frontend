          ...
          {showPaypalSubscription(paypalSubscription, stripeSubscription) && (
            <>
              <SubscriptionDetails
                ...
                specialStatusIndicator={undefined}
              />
            </>
          )}
              ...
              <SubscriptionDetails
                ...
                specialStatusIndicator={
                  ...
                  new Date(stripeSubscription.created * 1000) <
                    new Date('2021-12-13T17:12:10+00:00') && (
                    <>
                      ...
                      />
                      <Modal
                        show={autorenewNoticeVisible}
                        onHide={() => setAutorenewNoticeVisible(false)}
                        centered
                      >
                        <Modal.Body>
                          We are currently experiencing an issue where subscriptions created before
                          December 7th are not auto-renewing.
                          <br />
                          <br />
                          If your subscription is over and has not auto-renewed, you can cancel your
                          current subscription, then create a new subscription.
                          <br />
                          <br />
                        ...
                        <Modal.Footer>
                          <Button
                            variant="secondary"
                            onClick={() => setAutorenewNoticeVisible(false)}
                          >
                            Ok
                          </Button>
                        </Modal.Footer>
...
const SubscriptionDetails = ({
  ...
  const [cancelSubscriptionConfirmationVisible, setCancelSubscriptionConfirmationVisible] =
    useState(false)
  ...
  return (
    <div>
      ...
      <div className="d-flex">
        ...
        <div className="w-50">
          <div>
            <small className="text-muted">{endDateVerb} on</small>
          </div>
      ...
      <Modal
        ...
        onHide={() => setCancelSubscriptionConfirmationVisible(false)}
        centered
      >
        ...
        <Modal.Footer>
          <Button
            variant="secondary"
            onClick={() => setCancelSubscriptionConfirmationVisible(false)}
          >
            No
          </Button>
