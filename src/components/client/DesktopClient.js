...
function DesktopClient({ user, setUser }) {
  ...
  return (
    <>
      <Helmet>
        <title>Desktop client | osu!Collector</title>
      </Helmet>
          ...
          <div className='container col-xxl-8'>
            <div className='row flex-lg-row-reverse align-items-center g-5'>
              ...
              <div className='col-lg-6'>
                ...
                <p className='lead text-secondary'>
                  I had to find some way to monetize this project so that it could continue running on its own. I
                  figured something in similar vein to osu! supporter would be the best approach. Any support you give
